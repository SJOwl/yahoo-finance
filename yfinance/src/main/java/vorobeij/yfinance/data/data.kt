...
@Serializable data class QuoteSummary(
    @SerialName("error") val error: String?, @SerialName("result") val result: List<Result>
)
...
@Serializable data class Result(
    ...
    @SerialName("balanceSheetHistoryQuarterly") val balanceSheetHistoryQuarterly: BalanceSheetHistoryQuarterly,
...
@Serializable data class BalanceSheetHistoryQuarterly(
    @SerialName("balanceSheetStatements") val balanceSheetStatements: List<BalanceSheetStatement>,
    @SerialName("maxAge") val maxAge: Int
)
...
@Serializable data class Estimation(
    @SerialName("growth") val growth: DataEntry, @SerialName("period") val period: String
)
